        ...
        const utils = {
            ...
            getRandomBlock: () => {
                ...
                if (!(blockImg instanceof HTMLImageElement)) return;
        ...
        const logEntries = [
            {
                text: " Incoming HTTP request detected ...",
                timeOffset: 0 
            },
            {
                text: " Service waking up ...",
                timeOffset: 3
            },
            {
                type: "ascii",
                content: `__| |______________________________________________________________________________________________________________________________| |__
...
__   ______________________________________________________________________________________________________________________________   __
  | |                                                                                                                              | |`
            ...
            {
                text: " Allocating compute resources ...",
                timeOffset: 7
            },
            {
                text: " Preparing instance for initialization ...",
                timeOffset: 10
            },
            {
                text: " Starting the instance ...",
                timeOffset: 14
            },
            {
                text: " Environment variables injected ...",
                timeOffset: 20
            },
            {
                text: " Finalizing startup ...",
                timeOffset: 22
            },
            {
                text: " Optimizing deployment ...",
                timeOffset: 24
            },
            {
                text: " Steady hands. Clean logs. Your app is almost live ...",
                timeOffset: 26
            },
        ];
        ...
        const gridManager = {
            initializeBlockAssignments() {
                if (initialBlockAssignments) return;
            ...
            currentGridConfig.forEach((squareCount, rowIndex) => {
                ...
                for (let i = 0; i < squareCount; i++) {
                    ...
                    if (needsHangingBorder) {
                        ...
                        const shouldShowStaticBlock = !isReduced && utils.prefersReducedMotion() &&
                            CONFIG.staticBlockPositions.some(([r, s]) => r === rowIndex && s === i);
                        ...
                        if (enableHoverEffects) {
                            const timeouts = { slideIn: null, slideOut: null };
        ...
        async function testIfServerIsUp() {
            ...
            setTimeout(() => { controller.abort() }, queryTimeout);
